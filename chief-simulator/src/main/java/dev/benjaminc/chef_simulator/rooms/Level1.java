...
import dev.benjaminc.chef_simulator.things.building.Belt;
import dev.benjaminc.chef_simulator.things.building.Button;
import dev.benjaminc.chef_simulator.things.building.Counter;
import dev.benjaminc.chef_simulator.things.building.CuttingBoard;
import dev.benjaminc.chef_simulator.things.building.DishCounter;
import dev.benjaminc.chef_simulator.things.building.DishReturn;
import dev.benjaminc.chef_simulator.things.building.Dishwasher;
import dev.benjaminc.chef_simulator.things.building.Disposal;
import dev.benjaminc.chef_simulator.things.building.Fryer;
import dev.benjaminc.chef_simulator.things.building.Remover;
import dev.benjaminc.chef_simulator.things.building.Spawner;
import dev.benjaminc.chef_simulator.things.building.Stove;
import dev.benjaminc.chef_simulator.things.building.Window;
import dev.benjaminc.chef_simulator.things.food.Apple;
import dev.benjaminc.chef_simulator.things.food.Beef;
import dev.benjaminc.chef_simulator.things.food.Bun;
import dev.benjaminc.chef_simulator.things.food.Cheese;
import dev.benjaminc.chef_simulator.things.food.Lettuce;
...
import dev.benjaminc.chef_simulator.things.tools.Pan;
