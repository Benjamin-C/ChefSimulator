package dev.benjaminc.chef_simulator.chef_graphics.debug;
...
public class DataOMeter {
	...
	/** Alpha value of {@link DataOMeter} */
	private int av = 255-64;
	 ...
	 */
	public DataOMeter(int linedel, int width, int height, String title) {
		super();
	 ...
	 * @param title the {@link String} title of the meter
	 */
	public DataOMeter(int linedel, int width, int height, int maxValue, String title) {
		this(linedel, width, height, title);
	...
	public void draw(Graphics g, int left, int bottom, double fps) {
		...
		for(int i = 0; i < locs.length; i++) {
			...
			g.drawLine(left, l, left+width, l);
