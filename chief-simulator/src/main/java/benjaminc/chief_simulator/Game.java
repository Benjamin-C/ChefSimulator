...
public class Game {
	...
	public void mapDraw2() {
		...
		map.addThing(new Fryer(), 7, 4);
		map.addThing(new Counter(), 7, 3);
		map.addThing(new Stove(), 8, 4);
		...
		map.addThing(new Fryer(), 7, 11);
		map.addThing(new Stove(), 8, 11);
		...
		map.addThing(new Spawner(new Cheese()), 8, 0);
		map.addThing(new Spawner(new Apple()), 8, 15);
		map.addThing(new Spawner(new Potato()), 3, 3);
		...
		map.addThing(new Spawner(new Cheese()), 7, 15);
