package dev.orangeben.chef_textures;
...
import dev.orangeben.chef_textures.dialog.AreYouSureDialog;
import dev.orangeben.chef_textures.dialog.AreYouSureDialogRunnable;
import dev.orangeben.chef_textures.dialog.MessageDialog;
import dev.orangeben.chef_textures.shapelist.ShapeList;
import dev.orangeben.chef_textures.shapes.GraphicalShape;
import dev.orangeben.chef_utils.files.ShapeLoader;
import dev.orangeben.chef_utils.files.ShapeSaver;
import dev.orangeben.chef_utils.graphics.ShapeType;
import dev.orangeben.chef_utils.graphics.Texture;

public class TextureMain {

//	public static void main(String args[]) { // Could be main if wanted
	public static void run() {
		JFrame frame = new JFrame("Texture Editor");
		// Doesn't work RN, maybe later > frame.setBackground(Color.RED);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
//		frame.setIconImage(new ImageIcon("/assets/icon/texture_icon.png").getImage());
		frame.setIconImage(new ImageIcon("assets/icon/texture-icon.png").getImage());
