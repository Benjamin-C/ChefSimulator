package dev.orangeben.chef_simulator.things.tools;
...
import dev.orangeben.chef_simulator.data.Inventory;
...
import dev.orangeben.chef_simulator.things.types.PersistentThing;
import dev.orangeben.chef_simulator.things.types.WashableThing;
