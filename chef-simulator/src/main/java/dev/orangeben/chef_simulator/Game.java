...
import dev.orangeben.BenTCP.TCPClient;
import dev.orangeben.BenTCP.TCPOnDataArrival;
import dev.orangeben.BenTCP.TCPServer;
import dev.orangeben.BenTCP.TCPSetupStream;
import dev.orangeben.chef_simulator.chef_graphics.ActionType;
import dev.orangeben.chef_simulator.chef_graphics.GamePanel;
import dev.orangeben.chef_simulator.chef_graphics.GameSpace;
import dev.orangeben.chef_simulator.chef_graphics.GraphicalLoader;
import dev.orangeben.chef_simulator.control.Chef;
import dev.orangeben.chef_simulator.control.CommandProcessor;
import dev.orangeben.chef_simulator.control.EventHandler;
import dev.orangeben.chef_simulator.control.KeyListenAction;
import dev.orangeben.chef_simulator.control.TickEvent;
import dev.orangeben.chef_simulator.control.TickTimer;
import dev.orangeben.chef_simulator.control.command.ConnectCommand;
import dev.orangeben.chef_simulator.control.command.EventCommand;
import dev.orangeben.chef_simulator.control.command.FindCommand;
import dev.orangeben.chef_simulator.control.command.ListCommand;
import dev.orangeben.chef_simulator.control.command.MoveCommand;
import dev.orangeben.chef_simulator.control.command.SetCommand;
...
import dev.orangeben.chef_simulator.events.ChatEvent;
import dev.orangeben.chef_simulator.events.Event;
import dev.orangeben.chef_simulator.rooms.Level1;
...
import dev.orangeben.util.Util;
...
public class Game {
	...
	public static boolean usingOpenGL = false;
...
//			consoleInput(dataString);
	...
	public static void setupGame(int scale, int fps, boolean lago, boolean exitOnClose) {
		...
		GraphicalLoader.loadCache("chef-simulator/assets/chefgraphics/textures/");
